...
for i in range(0,len(CancerProjects)):
    ...
    Train_results='Train results for '+Project+': accuracy: '+str(accuracy0)+' recall:  '+str(recall0)+' precision:    '+str(precision0)+' fmeasure:  '+str(fmeasure0)+' mcc: ' +str(mcc0)
    ...
    Test_results='DEGNext Non-bio test results for '+Project+': accuracy: '+str(accuracy2)+' recall:  '+str(recall2)+' precision:   '+str(precision2)+' fmeasure:  '+str(fmeasure2)+' mcc:  ' +str(mcc2)
    print(Test_results)
	...
	File = dir_path+'/datasets/'+Project+'_non_bio_test_label.txt'
...
File='Performance_of_17_datasets_Exp_1_.txt'
np.savetxt(File, performance_by_dataset, fmt='%s')
File='AUC_of_17_datasets_Exp_1_.txt'
